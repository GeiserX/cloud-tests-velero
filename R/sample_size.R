...
gcp_cluster_hours <- gcp_cluster/3600
...
gcp_workload_hours <- gcp_workload/3600
...
aws_cluster_hours <- aws_cluster/3600
...
aws_workload_hours <- aws_workload/3600

sd_gcp_cluster <- sd(unlist(gcp_cluster_hours))
sd_gcp_workload <- sd(unlist(gcp_workload_hours))

sd_aws_cluster <- sd(aws_cluster_hours$time_elapsed)
sd_aws_cluster_no_oidc <- sd(aws_cluster_hours$time_elapsed_no_oidc)
sd_aws_workload <- sd(unlist(aws_workload_hours))
